    ...
    <div class="card-form card border-0 rounded-4 shadow-sm">
        <div class="card-header bg-white rounded-top-4 py-3" style="border-bottom: 2px solid #ffc107;">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="mb-0 fw-bold" style="color: #1b5e20;">Form Edit Produk</h5>
            </div>
        </div>
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.produk.update', $produk->id) }}" enctype="multipart/form-data"
                id="formEditProduk" novalidate>
                @csrf
                @method('PUT')

                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold" id="label_nama_produk">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold" id="label_kategori_id">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold" id="label_harga">
                        ...
                        <input type="number" name="harga" id="harga"
                            ...
                            value="{{ old('harga', $produk->harga) }}" placeholder="Masukkan harga produk">
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold" id="label_min_order">
                        ...
                        <input type="number" name="min_order" id="min_order"
                            ...
                            value="{{ old('min_order', $produk->min_order) }}">
                        <small class="text-muted">Untuk Paketan: sesuai kebutuhan (1,2,10,50, dll)</small>
                    ...
                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-semibold" for="is_snackbox_only">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input type="checkbox" name="is_snackbox_only" id="is_snackbox_only"
                                ...
                                {{ old('is_snackbox_only', $produk->is_snackbox_only) ? 'checked' : '' }}>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div class="current-image mb-2">
                            <img src="{{ $produk->gambar_url }}" class="current-img-thumb"
                        ...
                        <div class="upload-area">
                            ...
                            <small class="text-muted">Format: JPG, PNG. Maks: 2MB. Kosongkan jika tidak ingin mengubah
                                gambar.</small>
                ...
                <div class="action-buttons mt-4 pt-3 border-top">
                    ...
                    <button type="submit" class="btn btn-update rounded-pill px-4" id="btnSubmit">
...
/* Custom Toast untuk notifikasi - PERBAIKAN WARNA SUKSES HIJAU */
.custom-toast {
    position: fixed;
    top: 20px;
    right: 20px;
...
/* Toast success (hijau) - DITAMBAHKAN */
...
/* Warna ikon untuk success dan error */
...
document.getElementById('formEditProduk')?.addEventListener('submit', function(e) {
    ...
    fetch('{{ route("admin.produk.update", $produk->id) }}', {
            method: 'POST',
            body: formData,
            headers: {
...
// ============================================================
// CUSTOM TOAST NOTIFICATION (SUKSES HIJAU, ERROR MERAH)
