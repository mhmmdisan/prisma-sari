...
<div class="form-container">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Tambah rekening bank baru untuk pembayaran pelanggan</p>
        </div>
    ...
    <div class="card-form card border-0 rounded-4 shadow-sm">
        <div class="card-header bg-white rounded-top-4 py-3" style="border-bottom: 2px solid #ffc107;">
            <div class="d-flex align-items-center gap-2">
                ...
                <h5 class="mb-0 fw-bold" style="color: #1b5e20;">Form Tambah Rekening Bank</h5>
            </div>
        </div>
        <div class="card-body p-4">
            <form method="POST" action="{{ route('admin.metode-pembayaran.store') }}" enctype="multipart/form-data"
                id="formBank" novalidate>
                @csrf
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nama_bank" id="nama_bank"
                            ...
                            value="{{ old('nama_bank') }}" required placeholder="Contoh: Bank BCA">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nomor_rekening" id="nomor_rekening"
                            ...
                            value="{{ old('nomor_rekening') }}" required placeholder="Contoh: 1234567890">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="atas_nama" id="atas_nama"
                            ...
                            value="{{ old('atas_nama') }}" required placeholder="Contoh: PT Prisma Sari">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="upload-area">
                            <input type="file" name="logo_bank" id="logo_bank"
                                ...
                                accept="image/*">
                            <small class="text-muted">Format: JPG, PNG, SVG. Maks: 1MB</small>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input type="checkbox" name="status_aktif" class="form-check-input" id="status_aktif"
                                value="1" checked style="width: 18px; height: 18px; cursor: pointer;">
...
document.getElementById('formBank')?.addEventListener('submit', function(e) {
    ...
    fetch('{{ route("admin.metode-pembayaran.store") }}', {
            method: 'POST',
            body: formData,
            headers: {
